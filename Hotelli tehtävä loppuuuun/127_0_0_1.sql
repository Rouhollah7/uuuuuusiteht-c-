...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2024 at 01:24 PM
...
--
-- Database: `csharp_hotel_db`
--
CREATE DATABASE IF NOT EXISTS `csharp_hotel_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `csharp_hotel_db`;
...
(14, 'rouhollah', 'tajik', '046598787', 'mersu'),
(15, 'mohammad', 'bagheri', '0469619347', 'kuu');
...
INSERT INTO `reservations` (`reservId`, `roomNumber`, `clientId`, `DateIn`, `DateOunt`) VALUES
(26, 411, 15, '2024-05-28', '2024-05-31');
...
--
ALTER TABLE `reservations`
  MODIFY `reservId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
('root', '2024-05-28 10:54:45', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"en_GB\"}');
